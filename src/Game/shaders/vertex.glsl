...
// unifroms
uniform float uAmplitude;   // overall height of terrain
uniform float uFrequency;   // scale of terrain (distance between peaks)
uniform int   uOctaves;     // number of noise layers (detail level)
...
vec3 quintic3(vec3 t) { return t * t * t * (t * (t * 6.0 - 15.0) + 10.0); }
